 ...
 */
export function logUsage(provider, usage, model = null, connectionId = null, apiKey = null, billingSource = undefined) {
  ...
  saveRequestUsage({ model, provider, connectionId, tokens, apiKey: apiKey || undefined, billingSource }).catch(() => { });

...
@Module({
  ...
  providers: [OrdersService, AdminOrdersService, SourcingTimeoutService, SourcingTimeoutScheduler],
  exports: [OrdersService, AdminOrdersService, SourcingTimeoutService, SourcingTimeoutScheduler],
})

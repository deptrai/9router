 ...
 */
function buildGetChatMessageRequest(anthropicRequest, apiKey, modelUid) {
  const fields = [];
 ...
 */
function decodeGetChatMessageResponse(frame) {
  try {
 ...
 */
function connectFrameDecode(chunk) {
  const frames = [];
 ...
 */
function parseConnectEndFrame(frameBytes) {

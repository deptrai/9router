...
const BASE_URL = "https://9router.com";
const SKILL_PATH = "skills";

export const SKILLS_REPO_URL = BASE_URL;
export const SKILLS_RAW_BASE = `${BASE_URL}/${SKILL_PATH}`;
export const SKILLS_BLOB_BASE = `${BASE_URL}/${SKILL_PATH}`;

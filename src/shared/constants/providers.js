...
export const APIKEY_PROVIDERS = {
  ...
  windsurf: { id: "windsurf", alias: "windsurf", name: "Windsurf", icon: "waves", color: "#6366F1", textIcon: "WS", website: "https://windsurf.ai", notice: { text: "Free tier LLM (Cascade WS). Auto-extract token từ state.vscdb hoặc set WINDSURF_API_KEY env (devin-session-token$...).", apiKeyUrl: "https://windsurf.ai" }, serviceKinds: ["llm"], hasProviderSpecificData: false },

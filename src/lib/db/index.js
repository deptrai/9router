...
export {
  ...
  getApiKeysByUser, updateLastUsed,
...
export {
  ...
  sumUsageByConnection, getConnectionUsageStats,
...
export async function exportDb() {
  ...
  const out = {
    ...
    apiKeys: db.all(`SELECT * FROM apiKeys`).map((r) => ({ id: r.id, key: r.key, name: r.name, machineId: r.machineId, isActive: r.isActive === 1, createdAt: r.createdAt, userId: r.userId ?? null, description: r.description ?? null, lastUsedAt: r.lastUsedAt ?? null })),
